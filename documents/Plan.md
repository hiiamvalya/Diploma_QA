...
6. Купить тур по карте с валидными данными во все полях, но недостаточным количеством средств на счете. Ожидаемый результат: появилось всплывающее окно `Ошибка! Банк отказал в проведении операции`. Cтатус в БД “DECLINED”.
...
* Написание авто-тестов - до 02.01.2022   
